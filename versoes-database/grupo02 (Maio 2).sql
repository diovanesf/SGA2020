...
--
-- Host: localhost
-- Tempo de geração: 02/05/2021 às 21:11
...
(89, 1011, 'correios', 'equina', 'crostas', 'formol', 'coagulado', 'aguardando', 'granja', 600, 358, NULL, '555', '5655', 25, NULL, NULL, NULL, 1, '27/04/2021'),
...
(93, 123, 'rodoviaria', 'suina', 'soro', 'ambiente', 'coagulado', NULL, 'granja', 1212, 120, 'intensiva', '123', '123', NULL, NULL, NULL, NULL, 3, '02/05/2021'),
(94, 12, 'rodoviaria', 'bovina', 'soro', 'ambiente', 'coagulado', 'aceita', 'haras', 2, 2, 'semiextensiva', '1', '2', NULL, NULL, NULL, NULL, 1, '02/05/2021');
...
(81, 'upload/154053330608ef22ee4242.jpeg', NULL, 'certificado', 89);
...
--
ALTER TABLE `amostra`
  MODIFY `amostra_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;
