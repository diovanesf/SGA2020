...
--
-- Host: localhost
-- Tempo de geração: 01/05/2021 às 05:35
...
(68, 0, 'rodoviaria', 'ovina', 'crostas', 'congelada', 'coagulado', NULL, 'haras', 0, 0, NULL, 'x', '', NULL, NULL, NULL, NULL, 1, '01/05/2021');
...
--
-- Estrutura para tabela `tecnica_tratamento`
--
...
--
-- Despejando dados para a tabela `tecnica_tratamento`
--
...
(81, 'upload/2097039686085f054d177c.png', NULL, 'Image', 65);
...
(1, 'teste2@teste.com', '698dc19d489c4e4db73e28a713eab07b', 'Nivel Professor', '0', 1, 'UNIPAMPA', 'www.lattes.com', NULL, '2021-05-01 03:07:58'),
(3, 'teste@teste.com', '698dc19d489c4e4db73e28a713eab07b', 'Nivel Aluno', '1', 1, 'UNIPAMPA', 'www.lattes.com', NULL, '2021-05-01 03:08:05'),
...
--
-- Índices de tabela `tecnica_tratamento`
--
...
--
ALTER TABLE `amostra`
  MODIFY `amostra_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
...
--
ALTER TABLE `exame`
  MODIFY `exame_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT de tabela `proprietario`
--
ALTER TABLE `proprietario`
  MODIFY `proprietario_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
