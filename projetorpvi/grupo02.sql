...
--
-- Host: 127.0.0.1
-- Tempo de geração: 02-Maio-2021 às 03:57
...
(97, 100, 'transport', 'bovina', 'swab_ocular', 'formol', 'putrefacao', 'aceita', 'haras', 331, 33, 'aberta', '951', '159', NULL, NULL, NULL, NULL, 1, '01/05/2021'),
(98, 976, 'transport', 'ovina', 'soro', 'refrigerada', 'hemolisado', 'finalizada', 'rural', 331, 33, 'fechada', '963', '358', NULL, NULL, NULL, NULL, 3, '01/05/2021');
...
--
ALTER TABLE `amostra`
  MODIFY `amostra_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
...
--
ALTER TABLE `exame`
  MODIFY `exame_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
