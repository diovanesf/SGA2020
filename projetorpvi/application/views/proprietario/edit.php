      ...
      <div class="col-lg-12">
        <div class="panel-body">
          <h1 class="page-header"  style="font-size:30px;" >
            Editar Cadastro do Proprietário
          </h1>
          <?php extract($proprietario); ?>
          <form method="POST" action="<?php echo base_url() ?>proprietario/update/<?= $proprietario_id ?>">
            <div class="row" style="margin-top: 50px;">
              <div class="col-lg-12">
                ...
                <div class=" col-lg-6 form-group">
                  ...
                  <div>
                    <input id="" name="nome" class="form-control input-md" value="<?= $nome ?>">
                  </div>
                </div>
                ...
                <div class=" col-lg-6 form-group">
                  ...
                  <div>
                    <input id="" type="email" name="email" class="form-control input-md" value="<?= $email ?>">
                  </div>
                </div>
                ...
                <div class=" col-lg-6 form-group">
                  ...
                  <div>
                    <input id="" type="endereco" name="endereco" class="form-control input-md" value="<?= $endereco ?>">
                  </div>
                </div>
                ...
                <div class=" col-lg-3 form-group">
                  ...
                  <div>
                    <input id="" type="phone" name="telefone" class="form-control input-md" value="<?= $telefone ?>">
                  </div>
                </div>
                ...
                <div class=" col-lg-3 form-group">
                  ...
                  <div>
                    <input id="" name="cidade" class="form-control input-md" value="<?= $cidade ?>">
                  </div>
                </div>

                <div class="col-lg-3 form-group">
                  <label style="font-size:15px;" for="estado">Estado:</label>
                  <select id="combo1" name="estado" class="form-control">
                ...
                <div class=" col-lg-3 form-group">
                  ...
                  <div>
                    <input id="" type="text" name="cep"class="form-control .cep-mask" value="<?= $cep ?>">
                  </div>
                </div>
                ...
                <div class="col-lg-6 form-group">
                  ...
                  <div><input id="" type="text" class="form-control input-md" name="gps" value="<?= $gps ?>">
                  </div>
                </div>
              </div>
            </div>
